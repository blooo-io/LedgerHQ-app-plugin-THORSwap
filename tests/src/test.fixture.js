...
const PLUGIN_LIB_NANOS = { 'thorswap': Resolve('elfs/thorswap_nanos.elf') };
const PLUGIN_LIB_NANOX = { 'thorswap': Resolve('elfs/thorswap_nanox.elf') };
const PLUGIN_LIB_NANOSP = { 'thorswap': Resolve('elfs/thorswap_nanosp.elf') };
