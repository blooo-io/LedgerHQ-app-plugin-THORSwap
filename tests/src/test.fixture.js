...
const PLUGIN_LIB_NANOS = { 'THORSwap': Resolve('elfs/plugin_nanos.elf') };
const PLUGIN_LIB_NANOX = { 'THORSwap': Resolve('elfs/plugin_nanox.elf') };
const PLUGIN_LIB_NANOSP = { 'THORSwap': Resolve('elfs/plugin_nanosp.elf') };
